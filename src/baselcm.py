...
class BaseLCM(nn.Module):
    ...
    """
    def __init__(self, input_dim, hidden_dim, num_heads, num_layers, ff_dim, output_dim, dropout_rate=0.1):
    ...
    @classmethod
    def load(cls, path, input_dim, hidden_dim, num_heads, num_layers, ff_dim, output_dim, device='cpu'):
...
class DiffusionLCM(BaseLCM):
    ...
    def __init__(self, input_dim, hidden_dim, num_heads, num_layers, ff_dim, output_dim, 
                 diffusion_steps=10, dropout_rate=0.1):
        ...
        super(DiffusionLCM, self).__init__(
            input_dim, hidden_dim, num_heads, num_layers, ff_dim, output_dim, dropout_rate
        )
